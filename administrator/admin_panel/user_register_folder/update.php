<?php
  ...
  if(isset($_POST['submit_user_edit'])){
        ...
        $sql= "UPDATE user_account SET firstname='$firstname_user' , middlename='$middlename_user', lastname='$lastname_user' , gender='$gender_user' , age='$age_user' , email='$email_user', password= '$password_user' WHERE user_id= $id_user_edit";
