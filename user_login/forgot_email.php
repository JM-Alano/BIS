...
<body>
    ...
    <input type="email" id = "uname" name = "email" placeholder = "Enter Email" required><br>
    <input type="hidden" id = "uname" name = "fname"  value = <?php echo $_SESSION['firstname'] ;?> required><br>
    <input type="hidden" id = "uname" name = "lname"  value = <?php echo $_SESSION['lastname'] ;?> required><br>
