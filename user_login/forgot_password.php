...
<body>
    ...
    <input type="text" id = "uname" name = "fname" placeholder = "Firstname" required><br>

    <label for="">Lastname</label><br>
    <input type="text" id = "pwd" name = "lname" placeholder = "Lastname"><br>


    <input type="submit" id = "submit" value = "Request" name = "forgot"> 
    </div>
    ...
    <div id = "validation">
        <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
            <p><?php include('forgot_validation.php'); ?></p>
        </div>
